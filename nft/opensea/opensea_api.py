...
from game_NFT.opensea import utils
...
class OpenseaAPI:
    ...
    def __init__(self):
        ...
        """
        self.api_url = f"https://api.opensea.io/api/v1"
        self.apikey = "2f6f419a083c46de9d83ce3dbe7db601"

    def _make_request(self, endpoint=None, params=None, export_file_name="", return_response=False):
    ...
    def assets(self, owner=None, token_ids=None, collection=None, order_direction=None, asset_contract_address=None, asset_contract_addresses=None, limit=None, include_orders=False, cursor=None,export_file_name=""):
    ...
    def offers(self, asset_contract_address, token_id, limit=None,export_file_name=""):
...
if __name__ == '__main__':
    api = OpenseaAPI()
    result = api.bundles(asset_contract_address="0x34d85c9cdeb23fa97cb08333b511ac86e1c4e258", limit=5)
    for res in result["bundles"]:
        print("--res--:", res)